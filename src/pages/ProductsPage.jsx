...
const ProductsPage = ({item}) => {
  ...
  return (
    <div>
       ...
       <h1 className='text-[26px] font-bold text-center underline'>All Products</h1><hr/>
       <div className='items-center mb-4  space-x-4 align-middle'> 
        ...
        />
        <button onClick={() => handleSearch(input)} className='md:w-32 bg-primary hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-orange-600 transition ease-in-out duration-300 justify-center'>Search</button>
